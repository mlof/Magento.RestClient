...
namespace Magento.RestClient.Data.Models.Store
{
	public record StoreConfig
	{
		...
		[JsonProperty("base_url")] public Uri BaseUrl { get; set; }

		[JsonProperty("base_link_url")] public Uri BaseLinkUrl { get; set; }

		[JsonProperty("base_static_url")] public Uri BaseStaticUrl { get; set; }

		[JsonProperty("base_media_url")] public Uri BaseMediaUrl { get; set; }

		[JsonProperty("secure_base_url")] public Uri SecureBaseUrl { get; set; }

		[JsonProperty("secure_base_link_url")] public Uri SecureBaseLinkUrl { get; set; }
