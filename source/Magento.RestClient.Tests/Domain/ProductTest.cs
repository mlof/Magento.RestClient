...
using AttributeSet = Magento.RestClient.Models.Attributes.AttributeSet;
using Product = Magento.RestClient.Models.Products.Product;
    ...
    public class ProductTest : AbstractIntegrationTest
    {
        ...
        public void SetupProducts()
        {
            ...
            var attributeSetId = Client.Search.AttributeSets(builder =>
                    builder.WhereEquals(set => set.AttributeSetName, "Test Attribute Set"))
                .Items
                .SingleOrDefault()
                .AttributeSetId;
