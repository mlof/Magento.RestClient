...
namespace Magento.RestClient.Models.Carts
{
    public class ShippingMethod
    {
        ...
        [JsonProperty("method_code")] public string MethodCode { get; set; }

        [JsonProperty("carrier_title")] public string CarrierTitle { get; set; }

        [JsonProperty("method_title")] public string MethodTitle { get; set; }
        ...
        [JsonProperty("price_excl_tax")] public long PriceExclTax { get; set; }
