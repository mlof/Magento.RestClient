...
using Magento.RestClient.Modules.CatalogInventory.Models;
...
namespace Magento.RestClient.Modules.Catalog.Models.Products
{
	public record Product
	{
		...
		[JsonProperty("extension_attributes")] public Dictionary<string, dynamic> ExtensionAttributes { get; set; }
		...
		{
			return this.ExtensionAttributes["stock_item"] as StockItem;
		}
	}
}