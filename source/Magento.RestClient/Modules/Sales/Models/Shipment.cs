...
namespace Magento.RestClient.Modules.Sales.Models
{
	public record Shipment
	{
		...
		[JsonProperty("packages")] public List<dynamic> Packages { get; set; }
		...
		[JsonProperty("items")] public List<ShipmentItem> Items { get; set; }

		[JsonProperty("tracks")] public List<dynamic> Tracks { get; set; }
